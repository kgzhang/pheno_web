...
const HomeView: React.FC = () => {
  ...
  const { organization, branding, features, footer, loadInfoConfig } = useInfoStore()
    ...
    <div className="home-container">
      ...
      <div className="hero-section">
        <div className="glass-header">
          <div className="logo">
            <img src={organization().logo} alt={organization().name} className="logo-img" />
            <span style={{ fontSize: '1.3rem', fontWeight: 'bold' }}>{organization().name}</span>
          </div>
      ...
      <footer className="footer">
        <div className="footer-content">
          <p className="copyright">{footer()?.copyright || '© 2025 All rights reserved'}</p>
        </div>
      </footer>
    </div>
  )
